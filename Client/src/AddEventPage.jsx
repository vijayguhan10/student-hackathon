        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-white p-6 shadow rounded-md">
            <form>
              ...
              <button
                type="submit"
                className="bg-yellow-500 text-black w-full p-2 rounded hover:bg-yellow-600"
              >
                Post
              </button>
            </form>
          ...
          <div className="bg-white p-6 shadow rounded-md">
            ...
            <button
              type="button"
              className="bg-yellow-500 text-black px-4 py-2 rounded mt-4 w-full hover:bg-yellow-600"
            >
              Save
            </button>
          </div>
